...
public class FitnessController {
	...
	public String viewHomePage(Model model) {
		List<FitnessModel>listFitnessx = service.listAll();
	...
	public String showNewFitnessPage(Model model) {
		FitnessModel fitness = new FitnessModel();
	...
	public String saveFitness(@ModelAttribute("fitness") FitnessModel fitness ) {
	...
	public ModelAndView showEditFitnessPage(@PathVariable(name = "id") int id) {
		...
		FitnessModel fitness = service.get(id);
	...
	public String updateFitness(@ModelAttribute("fitness") FitnessModel fitness) {
		service.Save(fitness);
		return "/redirect:/";
	}
}
